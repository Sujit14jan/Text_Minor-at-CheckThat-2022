...
class Similarity(nn.Module):
    def __init__(self, mem_dim, hidden_dim, num_classes, domain_feature,feature_dim):
        ...
        self.wp = nn.Linear(self.mem_dim,4)
...
class SimilarityTreeLSTM(nn.Module):
    def __init__(self,  in_dim, mem_dim, hidden_dim, sparsity, freeze, num_classes, \
        ...
        self.similarity = Similarity( mem_dim, hidden_dim, num_classes,domain_feature,feature_dim)
